    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeelingTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendRequestStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostMediaTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friendships_FriendRequestStatuses_FriendRequestStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_FeelingTypes_FeelingTypeId",
                        column: x => x.FeelingTypeId,
                        principalTable: "FeelingTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Posts_VisibilityTypes_VisibilityTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostMediaTypeId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostMedias_PostMediaTypes_PostMediaTypeId",
                        column: x => x.PostMediaTypeId,
                        principalTable: "PostMediaTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeelingTypes_Name_IsActive",
                table: "FeelingTypes",
                columns: new[] { "Name", "IsActive" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FriendRequestStatuses_Name_IsActive",
                table: "FriendRequestStatuses",
                columns: new[] { "Name", "IsActive" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Friendships_FriendRequestStatusId",
                table: "Friendships",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostMedias_PostMediaTypeId",
                table: "PostMedias",
                column: "PostMediaTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_PostMediaTypes_Name_IsActive",
                table: "PostMediaTypes",
                columns: new[] { "Name", "IsActive" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Posts_FeelingTypeId",
                table: "Posts",
                column: "FeelingTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Posts_Location_IsActive",
                table: "Posts",
                columns: new[] { "Location", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_Posts_Title_IsActive",
                table: "Posts",
                columns: new[] { "Title", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_Posts_VisibilityTypeId",
                table: "Posts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReactionTypes_Name_IsActive",
                table: "ReactionTypes",
                columns: new[] { "Name", "IsActive" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisibilityTypes_Name_IsActive",
