    ...
    public partial class AddedLookupTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostMediaType", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FriendRequestStatus_Name_IsActive",
                table: "FriendRequestStatus",
                columns: new[] { "Name", "IsActive" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PostMediaType_Name_IsActive",
                table: "PostMediaType",
                columns: new[] { "Name", "IsActive" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ReactionType_Name_IsActive",
                table: "ReactionType",
                columns: new[] { "Name", "IsActive" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Tag_Name_IsActive",
                table: "Tag",
                columns: new[] { "Name", "IsActive" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VisibilityType_Name_IsActive",
